...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const SUBCATEGORY_ID = urlParams.get("subcat_id"); // Ajusta "subcat_id" según tu parámetro en la URL
    ...
    function SubcatProducts() {
        fetch("../../controller/controller.producto.php?op=get_products_by_subcategory", {
            method: "POST",
            body: new URLSearchParams({
                emp_id: EMPRESA_ID,
                subcat_id: SUBCATEGORY_ID // Incluir el ID de la subcategoría
