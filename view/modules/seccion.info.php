                ...
                <div class="row gx-1 gy-1 gy-xl-0">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        <div class="tp-feature-item d-flex align-items-start">
                            ...
                            <div class="tp-feature-content">
                                <h3 class="tp-feature-title">Entrega Gratis</h3>
                                <p>Apartir de S/. 900</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        <div class="tp-feature-item d-flex align-items-start">
                            ...
                            <div class="tp-feature-content">
                                <h3 class="tp-feature-title">Garantía de Calidad</h3>

                                <p>Helados de calidad</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        <div class="tp-feature-item d-flex align-items-start">
                            ...
                            <div class="tp-feature-content">
                                <h3 class="tp-feature-title">Gira y Gana</h3>
                                <p>Por compras de S/. 80</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        <div class="tp-feature-item d-flex align-items-start">
                            ...
                            <div class="tp-feature-content">
                                <h3 class="tp-feature-title">Soporte 24/7</h3>
                                <p>Activo</p>
                            </div>
                        </div>
                    </div>
