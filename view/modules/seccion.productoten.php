                                    ...
                                    <div class="row">
                                            ...
                                            <div class="tp-product-item p-relative transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    <a href="product-details.html">
                                                        <img src="assets/p/aguaje.png" alt="product-electronic">
                                                    </a>

                                                    <!-- product badge -->
                                                    <div class="tp-product-badge">
                                                        <span class="product-hot">Nuevo Sabor</span>
                                                    </div>
                                                    ...
                                                    <div class="tp-product-action">
                                                        <div class="tp-product-action-item d-flex flex-column">
                                                            ...
                                                            <button type="button" class="tp-product-action-btn tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                                                                ...
                                                                <span class="tp-product-tooltip">Ver Mas</span>
                                                            </button>
                                                ...
                                                <div class="tp-product-content">
                                                    ...
                                                    <div class="tp-product-price-wrapper">
                                                        <!-- <span class="tp-product-price old-price">S/. 5.00</span> -->
                                                        <span class="tp-product-price new-price">S/. 3.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6">
                                            <div class="tp-product-item transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    <a href="product-details.html">
                                                        <img
                                                            src="assets/P/chocolateconmani.png"
                                                    ...
                                                    <div class="tp-product-badge">
                                                        <span class="product-trending">Nuevo Sabor</span>
                                                    </div>
                                                ...
                                                <div class="tp-product-content">
                                                    <div class="tp-product-category">
                                                        <a href="shop.html">Chocolate Con Mani</a>
                                                    </div>
                                                    ...
                                                    <div class="tp-product-price-wrapper">
                                                        <span class="tp-product-price">S/ 5.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6">
                                            <div class="tp-product-item transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    <a href="product-details.html">
                                                        <img src="assets/P/cocona.png" alt="product-electronic">
                                                    </a>

                                                    <!-- product badge -->

                                                    <div class="tp-product-badge">
                                                        <span class="product-offer">Super rico</span>
                                                    </div>
                                                ...
                                                <div class="tp-product-content">
                                                    ...
                                                    <div class="tp-product-price-wrapper">
                                                        ...
                                                        <span class="tp-product-price new-price">D/. 3.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6">
                                            <div class="tp-product-item transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    <a href="product-details.html">
                                                        <img
                                                            src="assets/P/fresaguanabana.png"
                                                            alt="product-electronic">
                                                    </a>
                                                ...
                                                <div class="tp-product-content">
                                                    <div class="tp-product-category">
                                                        <a href="shop.html">Fresa y Guanabana</a>
                                                    </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6">
                                            <div class="tp-product-item transition-3 mb-25">
                                                ...
                                                <div class="tp-product-content">
                                                    ...
                                                    <div class="tp-product-price-wrapper">
                                                        <span class="tp-product-price">S/. 3.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6">
                                            <div class="tp-product-item transition-3 mb-25">
                                                ...
                                                <div class="tp-product-content">
                                                    <div class="tp-product-category">
                                                        <a href="shop.html">UNGURAHUI</a>
                                                    </div>

                                                    <h3 class="tp-product-title">
                                                        <a href="product-details.html">
                                                            PRUEBA EL NUEVO SABOR
                                                        </a>
                                                    </h3>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6">
                                            <div class="tp-product-item transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    <a href="product-details.html">
                                                        <img
                                                            src="assets/img/product/product-5-1.jpg"
                                                            alt="product-electronic">
                                                    </a>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6">
                                            <div class="tp-product-item transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    <a href="product-details.html">
                                                        <img
                                                            src="assets/img/product/product-5-2.jpg"
                                                            alt="product-electronic">
                                                    </a>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6">
                                            <div class="tp-product-item transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    <a href="product-details.html">
                                                        <img
                                                            src="assets/img/product/product-5-3.jpg"
                                                            alt="product-electronic">
                                                    </a>
                                                ...
                                                <div class="tp-product-content">
                                                    <div class="tp-product-category">
                                                        <a href="shop.html">rsgrgsefsef</a>
                                                    </div>
