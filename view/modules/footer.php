                ...
                <div class="row">
                        ...
                        <div class="tp-footer-widget footer-col-1 mb-50">
                            <div class="tp-footer-widget-content">
                                <div class="tp-footer-logo">
                                    <a href="index.html">
                                        <img
                                            src="<?php echo $url ?>assets/img/logo/footer_logo.png"
                                            alt="logo" height="100">
                                    </a>
                                </div>

                                <p class="tp-footer-desc">
                                    Somos una empresa dedicada a brindar productos de alta calidad. Contáctanos:
                                </p>

                                <div class="tp-footer-social">
                                    <a href="https://www.facebook.com/superfrio.helados/?locale=es_LA" target="_blank">
                                        <i class="fa-brands fa-facebook-f"></i>
                                    </a>

                                    <a href="https://www.instagram.com/superfrio.helados/" target="_blank" rel="noopener noreferrer">
                                        <i class="fa-brands fa-instagram"></i>
                                    </a>

                                    <a href="https://www.tiktok.com/@superfrios12345" target="_blank" rel="noopener noreferrer">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="tp-footer-widget footer-col-4 mb-50">
                            <h4 class="tp-footer-widget-title">Hable con nosotros</h4>
                            ...
                            <div class="tp-footer-widget-content">
                                <div class="tp-footer-talk mb-20">
                                    ...
                                    <h4>
                                        <a><?php echo htmlspecialchars($telefono); ?></a>
                                    </h4>
                                </div>
                                ...
                                <div class="tp-footer-contact">
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                                        ...
                                        <div class="tp-footer-contact-content">
                                            <p>
                                                <a href="mailto:<?php echo htmlspecialchars($correo); ?>"><?php echo htmlspecialchars($correo); ?></a>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                                        ...
                                        <div class="tp-footer-contact-content">
                                            <p>
                                                <a
                                                    href="https://maps.app.goo.gl/2V7GrgmhnnWmUmpr5"
                                                    target="_blank">
                        ...
                        <div class="col-md-6">
                            <div class="tp-footer-copyright">
                                <p>
                                    ...
                                    </script> Todos los derechos reservados | Tienda Virtual desarrollada por
                                    <a href="https://haromdev.com/" target="_blank">HaromDev</a>.
                                </p>
