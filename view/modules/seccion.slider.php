                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-5 col-lg-6 col-md-6">
                                    <div class="tp-slider-content p-relative z-index-1">
                                        <span>Precio <b>S/. 4</b></span>
                                        <h3 class="tp-slider-title">Nuevo Sabor 2024</h3>
                                        <p>
                                            <span>
                                        ...
                                        <div class="tp-slider-btn">
                                            <a href="<?php echo $url ?>view/productos/" class="tp-btn tp-btn-2 tp-btn-white">
                                                Comprar Ahora
                                ...
                                <div class="col-xl-7 col-lg-6 col-md-6">
                                    <div class="tp-slider-thumb text-end">
                                        <img src="assets/img/slider/camu camu.png" alt="slider-img" height="400">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide green-dark-bg">
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-7 col-lg-6 col-md-6">
                                    <div class="tp-slider-thumb text-end">
                                        <img src="assets/img/slider/935493281.png" alt="slider-img" height="400">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tp-slider-item is-light tp-slider-height d-flex align-items-center swiper-slide" data-bg-color="#E3EDF6">
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-7 col-lg-6 col-md-6">
                                    <div class="tp-slider-thumb text-end">
                                        <img src="assets/img/slider/137953065.png" alt="slider-img" height="400">
                                    </div>
                                </div>
                            </div>
                        </div>
