...
// funcion de los botones de agregar y eliminar
...
function addToWishlist(prodId, button) {
    fetch("controller/controller.producto.php?op=add_to_wishlist", {
        method: "POST",
...
function removeFromWishlist(prodId, button) {
    fetch("controller/controller.producto.php?op=remove_from_wishlist", {
        method: "POST",
        body: new URLSearchParams({ prod_id: prodId }),
        headers: {
            "Content-Type": "application/x-www-form-urlencoded"
